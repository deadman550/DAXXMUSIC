    ...
    upl = InlineKeyboardMarkup(
        [
            [
                ...
                InlineKeyboardButton(text="Bʟɪsᴛ",callback_data="help_callback hb3",),
            ],
            [
                InlineKeyboardButton(text="Bᴄᴀsᴛ",callback_data="help_callback hb4",),
                InlineKeyboardButton(text="Gʙᴀɴ",callback_data="help_callback hb12",),
                InlineKeyboardButton(text="Lʏʀɪᴄs",callback_data="help_callback hb5",),
            ],
            [
                InlineKeyboardButton(text="Pɪɴɢ",callback_data="help_callback hb7",),
                InlineKeyboardButton(text="Pʟᴀʏ",callback_data="help_callback hb8",),
                InlineKeyboardButton(text="Pʟɪsᴛ",callback_data="help_callback hb6",),
            ],
            [
                InlineKeyboardButton(text="Vᴄʜᴀᴛs",callback_data="help_callback hb10",),
            ...
            [
                InlineKeyboardButton(text="ᴛᴀɢᴀʟʟ",callback_data="help_callback hb13"),
            ],
            mark,
        ]
    )
